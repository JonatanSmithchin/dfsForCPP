...
class GetListingResponse final :
 ...
 public:
  ...
  public:
  void clear_dirlist();
  const ::DirestoryListing& dirlist() const;
  PROTOBUF_NODISCARD ::DirestoryListing* release_dirlist();
  ::DirestoryListing* mutable_dirlist();
  void set_allocated_dirlist(::DirestoryListing* dirlist);
  private:
  const ::DirestoryListing& _internal_dirlist() const;
  ::DirestoryListing* _internal_mutable_dirlist();
  public:
  void unsafe_arena_set_allocated_dirlist(
      ::DirestoryListing* dirlist);
  ::DirestoryListing* unsafe_arena_release_dirlist();
...
inline const ::DirestoryListing& GetListingResponse::_internal_dirlist() const {
  const ::DirestoryListing* p = _impl_.dirlist_;
  return p != nullptr ? *p : reinterpret_cast<const ::DirestoryListing&>(
      ::_DirestoryListing_default_instance_);
}
inline const ::DirestoryListing& GetListingResponse::dirlist() const {
...
inline ::DirestoryListing* GetListingResponse::release_dirlist() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::DirestoryListing* temp = _impl_.dirlist_;
...
inline ::DirestoryListing* GetListingResponse::unsafe_arena_release_dirlist() {
...
inline ::DirestoryListing* GetListingResponse::_internal_mutable_dirlist() {
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.dirlist_ == nullptr) {
    auto* p = CreateMaybeMessage<::DirestoryListing>(GetArenaForAllocation());
    _impl_.dirlist_ = p;
  }
  return _impl_.dirlist_;
}
inline ::DirestoryListing* GetListingResponse::mutable_dirlist() {
  ::DirestoryListing* _msg = _internal_mutable_dirlist();
  // @@protoc_insertion_point(field_mutable:ClientNamenode.GetListingResponse.dirList)
  return _msg;
}
inline void GetListingResponse::set_allocated_dirlist(::DirestoryListing* dirlist) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.dirlist_);
  }
