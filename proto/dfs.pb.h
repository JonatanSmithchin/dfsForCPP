...
class DirestoryListing;
struct DirestoryListingDefaultTypeInternal;
extern DirestoryListingDefaultTypeInternal _DirestoryListing_default_instance_;
class FileStatus;
...
template<> ::DirestoryListing* Arena::CreateMaybeMessage<::DirestoryListing>(Arena*);
...
class DirestoryListing final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:DirestoryListing) */ {
 public:
  inline DirestoryListing() : DirestoryListing(nullptr) {}
  ~DirestoryListing() override;
  explicit PROTOBUF_CONSTEXPR DirestoryListing(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  DirestoryListing(const DirestoryListing& from);
  DirestoryListing(DirestoryListing&& from) noexcept
    : DirestoryListing() {
    *this = ::std::move(from);
  }

  inline DirestoryListing& operator=(const DirestoryListing& from) {
    CopyFrom(from);
    return *this;
  }
  inline DirestoryListing& operator=(DirestoryListing&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const DirestoryListing& default_instance() {
    return *internal_default_instance();
  }
  static inline const DirestoryListing* internal_default_instance() {
    return reinterpret_cast<const DirestoryListing*>(
               &_DirestoryListing_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  friend void swap(DirestoryListing& a, DirestoryListing& b) {
    a.Swap(&b);
  }
  inline void Swap(DirestoryListing* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(DirestoryListing* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  DirestoryListing* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<DirestoryListing>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const DirestoryListing& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const DirestoryListing& from) {
    DirestoryListing::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(DirestoryListing* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "DirestoryListing";
  }
  protected:
  explicit DirestoryListing(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:DirestoryListing)
 private:
  class _Internal;
...
// repeated .FileStatus partialListing = 1;
inline int DirestoryListing::_internal_partiallisting_size() const {
  return _impl_.partiallisting_.size();
}
inline int DirestoryListing::partiallisting_size() const {
  return _internal_partiallisting_size();
}
inline void DirestoryListing::clear_partiallisting() {
  _impl_.partiallisting_.Clear();
}
inline ::FileStatus* DirestoryListing::mutable_partiallisting(int index) {
  // @@protoc_insertion_point(field_mutable:DirestoryListing.partialListing)
  return _impl_.partiallisting_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::FileStatus >*
DirestoryListing::mutable_partiallisting() {
  // @@protoc_insertion_point(field_mutable_list:DirestoryListing.partialListing)
  return &_impl_.partiallisting_;
}
inline const ::FileStatus& DirestoryListing::_internal_partiallisting(int index) const {
  return _impl_.partiallisting_.Get(index);
}
inline const ::FileStatus& DirestoryListing::partiallisting(int index) const {
  // @@protoc_insertion_point(field_get:DirestoryListing.partialListing)
  return _internal_partiallisting(index);
}
inline ::FileStatus* DirestoryListing::_internal_add_partiallisting() {
  return _impl_.partiallisting_.Add();
}
inline ::FileStatus* DirestoryListing::add_partiallisting() {
  ::FileStatus* _add = _internal_add_partiallisting();
  // @@protoc_insertion_point(field_add:DirestoryListing.partialListing)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::FileStatus >&
DirestoryListing::partiallisting() const {
  // @@protoc_insertion_point(field_list:DirestoryListing.partialListing)
  return _impl_.partiallisting_;
}

// uint32 remainingEntries = 2;
inline void DirestoryListing::clear_remainingentries() {
  _impl_.remainingentries_ = 0u;
}
inline uint32_t DirestoryListing::_internal_remainingentries() const {
  return _impl_.remainingentries_;
}
inline uint32_t DirestoryListing::remainingentries() const {
  // @@protoc_insertion_point(field_get:DirestoryListing.remainingEntries)
  return _internal_remainingentries();
}
inline void DirestoryListing::_internal_set_remainingentries(uint32_t value) {
  
  _impl_.remainingentries_ = value;
}
inline void DirestoryListing::set_remainingentries(uint32_t value) {
  _internal_set_remainingentries(value);
  // @@protoc_insertion_point(field_set:DirestoryListing.remainingEntries)
}
